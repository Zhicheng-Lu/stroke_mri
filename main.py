...
def main(argv):
	...
	if task == 'segmentation' and (step == 'test' or step == 'testing'):
		segmentation_test(data_reader, device, time, False)
	if task == 'segmentation' and (step == 'test' or step == 'testing_visual'):
		segmentation_test(data_reader, device, time, True)
